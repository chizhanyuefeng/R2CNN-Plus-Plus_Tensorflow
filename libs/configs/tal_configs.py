...
DATASET_NAME = 'TAL'  # 'ship', 'spacenet', 'pascal', 'coco'
...
ANCHOR_SCALES = [1/32, 1/16., 1/8., 1/4., 1/2., 1., 2.0]  # [4, 8, 16, 32]
ANCHOR_RATIOS = [1, 2, 3., 4., 5., 6., 7., 8.]#[1, 1 / 2, 2., 1 / 3., 3., 5., 1 / 4., 4., 1 / 5., 6., 1 / 6., 7., 1 / 7., 9., 1 / 9.]
